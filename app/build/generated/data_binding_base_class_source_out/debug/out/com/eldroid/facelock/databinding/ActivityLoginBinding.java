...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton tvForgot;
  ...
  private ActivityLoginBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull TextInputLayout tilPassword, @NonNull MaterialButton tvForgot,
      @NonNull MaterialButton tvRegister) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvForgot;
      MaterialButton tvForgot = ViewBindings.findChildViewById(rootView, id);
      if (tvForgot == null) {
        break missingId;
      }
